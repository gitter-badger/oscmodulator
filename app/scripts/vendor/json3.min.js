...
(function ()
{
    ...
    if (!t || !C)
    {
        ...
        {
            var d, j, f, p, g, h;
            if (typeof c == "function" || typeof c == "object" && c)if (l.call(c) == "[object Function]")j = c;
        ...
        {
            var d = b[c], j;
            if (typeof d == "object" && d)if (l.call(d) == "[object Array]")for (j = d.length; j--;)J(d, j, a);
            else n(d, function (b)
                {
                    J(d, b, a)
                });
